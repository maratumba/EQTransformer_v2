...
from .EqT_utils import DataGenerator, lr_schedule, cred2, data_reader
import datetime
...
def _build_model(ar):   
    ...
    inp1 = Input(shape= ar.input_dimention, name='input1')
    inp2 = Input(shape=(151, 41, 3), name='input2') 
...
def _document_training(history, model, start_training, end_training, save_dir, save_models, training_size, validation_size, ar): 
    ...
    with open(os.path.join(save_dir,'X_report.txt'), 'a') as the_file: 
        ...
        the_file.write('add_gap_r: '+str(ar.add_gap_r)+'\n')        
